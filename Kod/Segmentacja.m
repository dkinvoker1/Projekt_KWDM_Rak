function [ map ] = Segmentacja( Dicom , bigest_nerka_number)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here
%Dicom - macierz 3d z kolejnymi przekrojami(np 512x512x4)
%bigest_nerka_number - numer przekroju na którym lekarz zaznacza nerke(dobrze by by³o gdyby by³ to obszar z nawiêks¿¹ nerk¹, mo¿e to byæ np nómer obecnie widocznego przekroju w przegl¹darce)
...
I = im2double(Dicom(:,:,bigest_nerka_number));
I = imadjust(I);
data = [I(:)];
%Number of clusters
num_clust = 5;
